  ...
  return (
    <SectionWrapper id="about" className="section-bg">
      <div className="text-center mb-16">
        <h2 className="text-2xl md:text-4xl mb-4 section-title">Why A365</h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
        {STATS.map((stat, i) => (
          ...
          >
            <p className="text-2xl md:text-3xl  text-primary-600 dark:text-primary-400">{stat.value}</p>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="section-card p-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">AI agents for enterprise operations. Complex workflows, system integrations, compliance requirements.</p>
          </div>
          <div className="section-card p-6">
            <Globe className="w-10 h-10 text-primary-500 mb-4" />
            <h4 className="text-lg  text-gray-900 dark:text-gray-100 mb-2">A365Shift</h4>
